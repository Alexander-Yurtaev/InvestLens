...
openssl req -x509 -nodes -days 365 -newkey rsa:2048 -keyout "C:\docker-certs\invest-lens\investlens_web.key" -out "C:\docker-certs\invest-lens\investlens_web.crt" -subj "/CN=localhost" -addext "subjectAltName=DNS:localhost"
