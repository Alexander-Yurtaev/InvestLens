...
namespace InvestLens.Data.DataContext.Migrations
{
    ...
    [Migration("20260213020059_AddGinIndexesMigration")]
    partial class AddGinIndexesMigration
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("InvestLens.Data.Entities.SecurityEntity", b =>
                {
                    ...
                    NpgsqlIndexBuilderExtensions.HasMethod(b.HasIndex("SecId"), "GIN");
                    NpgsqlIndexBuilderExtensions.HasOperators(b.HasIndex("SecId"), new[] { "gin_trgm_ops" });
