...
public interface ITelegramBotClient
{
    ...
    Task NotifyOperationStartAsync(Guid correlationId, string details, CancellationToken cancellationToken = default);
    Task NotifyOperationCompleteAsync(Guid correlationId, string result, TimeSpan duration, CancellationToken cancellationToken = default);
    Task NotifyInfoAsync(string title, string message, CancellationToken cancellationToken = default);
    Task NotifyErrorAsync(Guid correlationId, string exceptionMessage, CancellationToken cancellationToken = default);
